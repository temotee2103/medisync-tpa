...
This project builds as a Node.js server (Next.js standalone output) for deployment behind a reverse proxy.

See [docs/deployment/server-build.md](docs/deployment/server-build.md) for the full deployment contract and runtime requirements.

Copy `.env.example` to `.env` and fill in all required environment variables before building.
